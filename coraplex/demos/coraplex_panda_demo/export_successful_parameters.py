...
A joint probability tree does not need this order to learn, but it keeps the columns,
the learned variables and any plot of them in an order a reader can follow.
"""
