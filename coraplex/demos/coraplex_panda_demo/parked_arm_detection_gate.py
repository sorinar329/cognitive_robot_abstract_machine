...
class ParkedArmDetectionGate:
    ...
    """
    How far (in radians) a joint may sit from its park target and still count as arrived.
    """
    ...
    """
    Seconds to keep waiting once the wait for the arm is over, so the cubes are read after
    they have stopped moving too.
    """
