...
class AbstractRobot(Agent, HasRobotParts, ABC):
    ...
    *   **Initialization**: Sub-parts are automatically instantiated based on
    ...
    def _tighten_dof_derivative_limits_of_1dof_connections(
        ...
        :param derivative: The derivative (velocity, acceleration, or jerk) whose limits
            are tightened.
        :param new_limits: A dictionary linking 1DOF connections to their corresponding
            ...
            limit resolves to ``None`` (e.g. via a ``defaultdict(lambda: None)``) is left
            unchanged.
        """
    ...
    def tighten_dof_acceleration_limits_of_1dof_connections(
        ...
        :param new_limits: A dictionary linking 1DOF connections to their corresponding
            new acceleration limits. The keys are of type `ActiveConnection1DOF`, and the
    ...
    def tighten_dof_jerk_limits_of_1dof_connections(
        ...
        :param new_limits: A dictionary linking 1DOF connections to their corresponding
            ...
            represent the new limits specific to each connection.
        """
        self._tighten_dof_derivative_limits_of_1dof_connections(
