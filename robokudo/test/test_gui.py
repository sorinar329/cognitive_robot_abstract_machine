...
def function_setup(node):
    ...
    FakeVisualizer.test_number = 0  # Reset test number to count calls in static post tick test
    yield
...
class TestVisualizerObject(object):
    ...
    def test_visualizer_instantiation_subtypes(self, function_setup):
        ...
        CVVisualizer.new_visualizer_instance(pipeline=root, shared_visualizer_state=shared_state)
