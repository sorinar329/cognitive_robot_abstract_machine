...
class SizeBBAnnotator(robokudo.annotators.core.BaseAnnotator):
    ...
    def __init__(self, name="SizeBBAnnotator"):
    ...
    def update(self) -> py_trees.common.Status:
        ...
        * Updates visualization
        ...
        for oh in object_hypotheses:
            ...
            cluster_cloud_mat_2d = (np.asarray(cluster_cloud_in_world.points)[:, 0:2] * 1000).astype(np.int32)
            ...
            rotation_matrix_in_world = [[cos_a, -sin_a, 0],
                                        [sin_a, cos_a, 0],
                                        [0, 0, 1]]
            ...
            visualization_img = cv2.rectangle(
                visualization_img, (int(x1), int(y1)), (int(x2), int(y2)), (0, 0, 255), 2
            )
