...
function evaluateGraphJs() {
  ...
  new Function('window', BrowserSource.read(path.join(WEB, 'core/graph-gestures.js')))(global.window);
  global.GraphGestures = global.window.GraphGestures;
  global.vis = { DataSet: ItemStore, Network: RecordingRenderer };
  new Function(BrowserSource.read(path.join(WEB, 'panels/graph/graph.js')))();
