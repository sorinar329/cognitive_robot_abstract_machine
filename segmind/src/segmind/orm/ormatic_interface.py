...
class EventAboutObjectDAO(
    DetectionEventDAO, DataAccessObject[segmind.datastructures.events.EventAboutObject]
):
    __tablename__ = "EventAboutObjectDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "EventAboutObjectDAO",
...
class MotionEventDAO(
    EventAboutObjectDAO, DataAccessObject[segmind.datastructures.events.MotionEvent]
):
    __tablename__ = "MotionEventDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(EventAboutObjectDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )
    ...
    __mapper_args__ = {
        ...
        "inherit_condition": database_id == EventAboutObjectDAO.database_id,
        "polymorphic_load": "selectin",
    }


class RelationEventDAO(
    EventAboutObjectDAO, DataAccessObject[segmind.datastructures.events.RelationEvent]
):
    __tablename__ = "RelationEventDAO"
    ...
    with_object: Mapped[semantic_digital_twin.world_description.world_entity.Body] = (
        mapped_column(
            sqlalchemy.sql.sqltypes.JSON, nullable=False, use_existing_column=True
        )
    )
    ...
    __mapper_args__ = {
        "polymorphic_identity": "RelationEventDAO",
        "inherit_condition": database_id == EventAboutObjectDAO.database_id,
        "polymorphic_load": "selectin",
    }
...
class AbstractContactEventDAO(
    ...
    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(RelationEventDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )
    ...
    __mapper_args__ = {
        ...
        "inherit_condition": database_id == RelationEventDAO.database_id,
        "polymorphic_load": "selectin",
    }
...
class ContainmentEventDAO(
    RelationEventDAO, DataAccessObject[segmind.datastructures.events.ContainmentEvent]
):
...
class InsertionEventDAO(
    RelationEventDAO, DataAccessObject[segmind.datastructures.events.InsertionEvent]
):
...
class LossOfSupportEventDAO(
    RelationEventDAO, DataAccessObject[segmind.datastructures.events.LossOfSupportEvent]
):
...
class PickUpEventDAO(
    RelationEventDAO, DataAccessObject[segmind.datastructures.events.PickUpEvent]
):
...
class PlacingEventDAO(
    RelationEventDAO, DataAccessObject[segmind.datastructures.events.PlacingEvent]
):
...
class SupportEventDAO(
    RelationEventDAO, DataAccessObject[segmind.datastructures.events.SupportEvent]
):
