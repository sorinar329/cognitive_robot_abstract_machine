"""
A feed of the events a monitor detects, kept for whoever reads them later or as they
come, such as the live event dashboard.
"""
...
class EventFeed:
    ...
    Listens to a :class:`~segmind.monitor.SegmindMonitor` directly: it is one of the
    monitor's listeners.
    """
