...
from coraplex.visualization import VisualizationOption, VisualizationSession
...
VISUALIZATION_BACKEND_VARIABLE = VisualizationOption.BACKEND
"""
...
def start(world: World, port: int = DEFAULT_PORT) -> LiveVisualization:
    ...
    """
    return visualization.LiveVisualization(world=world, port=port).start()
...
def main() -> None:
    ...
    os.environ.setdefault(
        VISUALIZATION_BACKEND_VARIABLE, VisualizationBackend.CRAMERA.value
    )
